  ...
  return (
    ...
    >
      <aside
        ...
        className={`absolute inset-y-0 left-0 flex w-72 flex-col border-r border-slate-200/80 bg-[#fbfaf7]/94 pb-3 ${topSafePadding} backdrop-blur-xl`}
      >
        ...
        <nav aria-label="主要导航" className="mt-7 shrink-0">
          ...
          <p
            aria-hidden={!expanded}
            className={`m-0 mb-2 mt-5 whitespace-nowrap px-7 text-[11px] font-bold uppercase tracking-[0.14em] text-slate-400 transition-[opacity,transform] duration-150 ease-out ${disclosureClass}`}
          >
            学习空间
          </p>
        ...
        >
          <div
            aria-hidden={!expanded}
            className={`flex h-8 shrink-0 items-center justify-between px-2.5 transition-[opacity,transform] duration-150 ease-out ${disclosureClass}`}
          >
